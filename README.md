...
Use it at **[toolbox.bitspire.ch](https://toolbox.bitspire.ch)** - install it as a PWA and every tool keeps working offline.
...
Run tests - `npm test` covers the Angular app and `npm run test:wasm` covers the .NET

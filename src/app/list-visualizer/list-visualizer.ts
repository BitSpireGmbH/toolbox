      ...
      <div class="bg-white rounded-xl shadow-md border border-gray-200 p-5 mb-6">
        <div class="flex flex-wrap items-start gap-4">
          <div class="min-w-37.5 flex flex-col">
             <label for="initialCapacityInput" class="block text-xs font-semibold text-gray-700 mb-2">Initial Capacity</label>
             <input
                id="initialCapacityInput"
                type="number"
          ...
          <div class="flex-1 min-w-50 flex flex-col">
             <label for="elementValueInput" class="block text-xs font-semibold text-gray-700 mb-2">Element Value</label>
             <div class="flex gap-2">
                <input

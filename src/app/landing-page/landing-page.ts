        ...
        <main class="space-y-12">
          ...
          <section>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <!-- Regex Tester Card -->
              <a routerLink="/regex-tester"
                 class="group relative block bg-white rounded-lg shadow-sm hover:shadow-xl transition-all duration-300 p-4 border border-gray-200 hover:border-fuchsia-500 overflow-hidden focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:ring-offset-2">
                <div class="absolute inset-0 bg-linear-to-br from-fuchsia-500/0 via-fuchsia-500/0 to-fuchsia-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div class="relative">
                  <div class="flex items-center gap-3 mb-3">
                    <div class="w-10 h-10 bg-linear-to-br from-fuchsia-500 to-pink-600 rounded-md flex items-center justify-center text-white shadow-sm group-hover:shadow-md group-hover:shadow-fuchsia-500/25 transition-all duration-300" aria-hidden="true">
                      <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div>
                      <h3 class="text-base font-bold text-gray-900 group-hover:text-fuchsia-600 transition-colors duration-300">Regex Tester</h3>
                      <span class="text-xs text-gray-500 font-medium">Pattern Matching & Codegen</span>
                    </div>
                  </div>
                  <p class="text-sm text-gray-600 leading-relaxed mb-3">Test .NET regex with live matches and generate source-generated or classic C# code.</p>
                  <div class="flex items-center gap-1.5 text-fuchsia-600 font-semibold text-xs">

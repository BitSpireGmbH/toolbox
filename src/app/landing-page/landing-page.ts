      ...
      <div class="max-w-5xl w-full">
        ...
        <div class="text-center mb-16 animate-fade-in">
          <div class="mb-6 relative inline-block">
            <div class="absolute inset-0 bg-gradient-to-r from-[#1976D2] to-[#9C27B0] blur-2xl opacity-20 rounded-full"></div>
            <img src="bitspire-logo.webp" alt="Bitspire Logo" class="w-56 mx-auto relative" />
          </div>
          <h1 class="text-6xl font-bold bg-gradient-to-r from-[#1976D2] to-[#9C27B0] bg-clip-text text-transparent mb-4">
            .NET Swiss Army
          </h1>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <a routerLink="/csharp-json" 
            ...
            <div class="absolute inset-0 bg-gradient-to-br from-[#1976D2]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div class="relative">
              <div class="flex items-center gap-4 mb-6">
                <div class="w-14 h-14 bg-gradient-to-br from-[#1976D2] to-[#1565C0] rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                ...
                <div>
                  <h2 class="text-2xl font-bold text-gray-900 group-hover:text-[#1976D2] transition-colors">JSON → C#</h2>
              ...
              <div class="mt-6 flex items-center gap-2 text-[#1976D2] font-semibold text-sm group-hover:gap-3 transition-all">
          ...
          <a routerLink="/csharp-typescript" 
             class="group relative block bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 p-8 border border-gray-200/50 hover:border-[#9C27B0]/50 hover:-translate-y-1 overflow-hidden">
            <div class="absolute inset-0 bg-gradient-to-br from-[#9C27B0]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            <div class="relative">
              <div class="flex items-center gap-4 mb-6">
                <div class="w-14 h-14 bg-gradient-to-br from-[#9C27B0] to-[#7B1FA2] rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
                  <svg class="w-7 h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div>
                  <h2 class="text-2xl font-bold text-gray-900 group-hover:text-[#9C27B0] transition-colors">C# ↔ TypeScript</h2>
